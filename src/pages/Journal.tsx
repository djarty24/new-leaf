				...
				<div className="fixed inset-0 z-50 bg-neutral-50 overflow-y-auto pb-24 animate-in slide-in-from-bottom-full duration-300">
					<div className="max-w-md mx-auto p-4 pt-12 space-y-8">
							...
							<div className="grid grid-cols-2 gap-2">
								{moodOptions.map((mood) => (
									<button
										...
										className={`py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all border ${selectedMood === mood.id
						...
						<button
							...
							onClick={handleSave}
							className={`w-full py-4 rounded-2xl font-medium flex items-center justify-center gap-2 transition-all ${saveSuccess
